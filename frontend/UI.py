...
<html>
    <head>
        ...
        <style>
            ...
            /* INJECTION DU ZOOM ICI POUR NE PAS CASSER LES TESTS UNITAIRES DE L'INTERFACE */
            .custom-modal-zoom .modal-dialog { max-width: 90vw !important; }
        </style>
    </head>
...
# --- CALLBACK POUR LE ZOOM DES IMAGES ---
@app.callback(
